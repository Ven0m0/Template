...
1. `token-efficient.md` - Communication protocol
1. `bash.instructions.md` - Primary language (74.5%)
...
1. Load language-specific instructions
1. Load `performance.instructions.md` if relevant
1. Use compressed response format

### Refactoring

1. Load `copilot-instructions.md` for repo patterns
1. Load language instructions
1. Load `performance.instructions.md`
1. Follow "Edit > Create" principle

### New Feature

1. Load `copilot-instructions.md` for structure
1. Load language instructions
1. Check `actions.instructions.md` if CI/CD needed
...
1. Update this index if scope changes
1. Update token estimates
1. Notify in commit message
